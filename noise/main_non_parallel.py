...
TEST_CONFIG = [
    ...
    {'name': 'motion', 'func': apply_motion_effect, 'params': {'effect': 'both', 'length': [10, 15], 'angle': [30, 120], 'intensity': [2.0]}}
]
...
if __name__ == '__main__':
    IMAGE_LIST = [
        "0010_GT_SRGB_010.PNG",
        "0036_GT_SRGB_010.PNG",
        "0068_GT_SRGB_010.PNG",
        "0083_GT_SRGB_010.PNG",
        "0104_GT_SRGB_010.PNG",
        "0129_GT_SRGB_010.PNG",
        "0159_GT_SRGB_010.PNG",
        "0189_GT_SRGB_010.PNG",
        "0197_GT_SRGB_010.PNG",
